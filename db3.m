...
b=imread(file);
[file, pathname] = uigetfile('*.png','Load Image 3 ');cd(pathname);
m=imread(file);
...
[a1,b1,c1,d1]=dwt2(a,'db3');
[a2,b2,c2,d2]=dwt2(b,'db3');
